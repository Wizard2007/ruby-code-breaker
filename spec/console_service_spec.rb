...
module Codebreaker
  RSpec.describe ConsoleService, 'Test ConsoleService' do
    ...
    context '# Test main console procedures ' do
      ...
      it 'shoud print your win' do
        subject.instance_variable_set(:@is_game_over, false)
        expect{subject.your_win}.to output("your win\n").to_stdout
      ...
      array_of_main_function = [:exit_, :hint, :show_validation_result, :your_win, :your_lose, :restart_game, :yes, :no]
